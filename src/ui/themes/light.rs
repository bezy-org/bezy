...
impl BezyTheme for LightTheme {
    ...
    fn selected_secondary_color(&self) -> Color {
        Color::srgba(0.5, 0.3, 0.0, 1.0)
    }

    fn hover_point_color(&self) -> Color {
        Color::srgba(0.0, 0.6, 1.0, 0.7)
    }
